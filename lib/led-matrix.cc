...
void RGBMatrix::SetPixelBytes(int x, int y, int width, int height, uint8_t *bytes) {
...
void FrameCanvas::SetPixelBytes(int x, int y, int width, int height, uint8_t* bytes){
  frame_->SetPixelBytes(x, y, width, height, bytes);
}
